...
import ro.ubbcluj.cs.ams.auth.model.tables.records.OauthClientTokenRecord;
...
public class OauthClientToken extends TableImpl<OauthClientTokenRecord> {
    ...
    private static final long serialVersionUID = 1194383997;
     ...
     */
    public final TableField<OauthClientTokenRecord, String> AUTHENTICATION_ID = createField(DSL.name("authentication_id"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
